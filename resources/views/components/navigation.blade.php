            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex overflow-x-scroll">
                        ...
                        <x-nav-link :href="route('indusrties.index')" :active="request()->routeIs('indusrties.index')">
                            {{ __('Отрасли') }}
                        </x-nav-link>
                        <x-nav-link :href="route('profis.index')" :active="request()->routeIs('profis.index')">
                            {{ __('Профили') }}
                        </x-nav-link>
                        <x-nav-link :href="route('helps.index')" :active="request()->routeIs('helps.index')">
                            {{ __('Помощь') }}
                        </x-nav-link>
